            ...
            <div className="relative">
                  ...
                  >
                        ...
                        <input
                              ...
                              className="w-fit h-10 bg-transparent outline-none text-sm text-white pr-12"
                              style={{
                                    paddingLeft: "1rem",
...
export default function LoginForm() {
      ...
      return (
            <div
                  className="min-h-fit flex  gap-4 items-center justify-center px-6 py-5"
                  style={{ background: "#0a0a0a", fontFamily: "'DM Mono', monospace" }}
            >
                  {/* ambient glows */}
                  <div className="fixed top-0 left-1/5 w-107 h-96 rounded-full blur-3xl opacity-10 pointer-events-none"
                        style={{ background: "#f43f5e" }} />
                  <div className="fixed bottom-0 right-1/4 w-100 h-80 rounded-full blur-3xl opacity-10 pointer-events-none"
                              ...
                              <div className="relative p-8 space-y-8">
                                    ...
                                    <div className="flex flex-col items-center gap-2 pb-4">
                                          ...
                                          <div className="text-center">
                                                ...
                                                <p
                                                      className="text-xs text-slate-500 mt-0.5 tracking-widest uppercase"
                                                      style={{
                                    ...
                                    {!success ? (
                                          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                                                ...
                                                <div className="flex justify-end">
                                                      <button type="button"
                                                            className="text-xs text-neutral-400 hover:text-neutral-300 transition-colors font-mono tracking-wide"
                                                            style={{
                                                                  color: 'rgb(255, 211, 213)'
                                                            }}>
                                                            <strong>
                                    ...
                                    <p className="text-center text-md text-neutral-500">
                                          No account?{" "}
                                          <a href="/signup" className="text-white hover:text-neutral-400 transition-colors font-mono">
                                                Create one →
                                          </a>
                                    </p>
                              </div>
